...
from e_clawhisper.shared.settings import AgentBackend, AppConfig, STTBackend, TTSBackend, settings

app = cyclopts.App(name="config", help="Configuration inspection commands.")
console = Console(stderr=True)

_ETC_CONFIG = "/etc/e-clawhisper/config.yaml"
...
def init(*, force: bool = False) -> None:
    """Copy default config to ~/.config/e-clawhisper/config.yaml."""
